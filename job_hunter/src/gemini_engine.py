...
def generar_latex_cv(vacante_id: int, user_id: str = 'default_user') -> str | None:
    ...
    system_msg = (
        ...
        "Incluye ÚNICAMENTE tecnologías y experiencias del perfil del candidato inyectado arriba "
        "en '=== PERFIL DEL CANDIDATO ==='. "
        "NUNCA inventes habilidades, certificaciones, publicaciones ni experiencias ausentes del perfil. "
        "NUNCA uses datos, logros o publicaciones de otro candidato distinto al inyectado en este prompt.\n\n"
        ...
        "    {linkedin del candidato} \\quad|\\quad {github del candidato} (solo si existen en el perfil) \\\\ \\vspace{1mm}\n"
        ...
        "  2. Technical Skills / Habilidades Técnicas — agrupa en 3-5 categorías por dominio "
        "(ej. Design/CAD, Programming, Automation, Languages, etc.) construidas ÚNICAMENTE a partir "
        "de las Skills listadas arriba en '=== PERFIL DEL CANDIDATO ==='. "
        "PROHIBIDO usar nombres de categorías o herramientas de un dominio distinto al del candidato "
        "(ej. no menciones CAD/mecánica si el candidato es de software, ni frameworks web si es mecánico) "
        "salvo que aparezcan explícitamente en sus Skills.\n"
