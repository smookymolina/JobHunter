...
\usepackage{babel}           % sin opcion [spanish] — evita error en TeX Live sin babel-spanish
...
\usepackage{xcolor}
\usepackage{parskip}
% fontawesome5 ELIMINADO — no esta instalado en este TeX Live
...
\textbf{Tel:} {{TELEFONO}} \quad
\textbf{Ubicaci\'on:} {{UBICACION}}
